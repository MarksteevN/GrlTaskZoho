namespace GRLZOHO.Data
{
    ...
    public class DocumentDetail
    {
        ...
        public string encattr_parent_name { get; set; }
        public List<TotalResource> total_resources { get; set; }
        public Preference preference { get; set; }
        public List<Dataobj> dataobj { get; set; }
        public string ws_type { get; set; }
        public string enc_parent_name { get; set; }
        public List<object> display_fields { get; set; }
    }
